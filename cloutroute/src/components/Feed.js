...
class Feed extends Component {
  ...
  render(){
    ...
    if (subways !== undefined && subways.length !== 0){
      subwayComponents = subways.map((station,i) => (
        <div className="subway-stop-widget-container">
          <SubwayArrivals key={i} stationId={station}></SubwayArrivals>
        </div>
      ));
    }
      ...
      routeComponents = routes.map(
        (route,i) => (
          <div className="route-widget-container">
            <RouteComp origin={route.origin} destination={route.destination}/>
          </div>
        ));
    }
      ...
      return (
        ...
        <div className="subway-scroll-container">
          <div className="subway-stops-container">
            <div className="add-subway-stop-widget">
        ...
        <div className="routes-container">
          <div className="add-route-widget">
